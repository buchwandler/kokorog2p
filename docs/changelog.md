...
## [0.9.1] - 2026-09-03
### Added
- Added an opt-in Swedish NST pronunciation lexicon and normalized German lexicon output before fallback processing
...
- Migrated the production English, German, French, and Japanese lexicons to
  deterministic verified G2Lex assets.
- Added named ordered lexicon selection and registry discovery APIs.
