...
LANGUAGES: dict[str, dict[str, Any]] = {
    ...
    "ru": {
        ...
        "slug": "ru",
        "sentences": (
            "Лиса прыгает и собака.",
            "Кофе и тёплый хлеб к столу.",
            "Произношение помогает понимать фразу.",
            "Подготовленный русский текст, а тест измеряет этап.",
        ),
    },
    "kk": {
        "label": "Kazakh",
    ...
    "th": {
        ...
        "sentences": (
            ...
            "อ่านข้อความภาษาไทยที่เตรียมไว้และการทดสอบวัดทุกขั้นตอน",
        ),
    },
}
