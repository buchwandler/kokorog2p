...
| ---------------------------- | ------------------------------------- | ------------------------------------ | -------------- | ----------------------------------- | ---------------------------- |
| `thai_cleanroom_cases.jsonl` | Independently authored by the project | CC0-compatible project-authored text | 2026-08-27     | LexHint or human review when frozen | Allowed with this repository |
