...
The current wheel contains the generated lexicons and notices. Canonical source files are
excluded from both release artifact types, as checked by `scripts/check_release_artifacts.py`.
