...
NUMBERED_UNITS = (
    ...
    NumberedUnit(r"Stck\.", "Stück", "Stück", "n", dotted=True),
    NumberedUnit(r"ltr\.", "Liter", "Liter", dotted=True),
    NumberedUnit(r"Std\.", "Stunde", "Stunden", "f", dotted=True),
    NumberedUnit(r"Min\.", "Minute", "Minuten", "f", dotted=True),
    NumberedUnit(r"Sek\.", "Sekunde", "Sekunden", "f", dotted=True),
